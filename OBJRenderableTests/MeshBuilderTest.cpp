...
MeshBuilderTest::MeshBuilderTest()
{
	m_testPositionArray = {
		...
		Vector3(-46.1389732f, -52.1872177f, 94.3361282),
		Vector3(-43.4172401f, -61.6218491f, 86.3813324),
		Vector3(-30.4940624f, -63.7362518f, 93.3937225),
		Vector3(-32.0030632f, -53.6164703f, 102.896698)
	};
